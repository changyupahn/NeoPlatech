...
public class SubPartSendListScheduler {
	...
	public void insertBatchSchdul() throws Exception {
		...
		jobDetail.setJobClass(SubPartSendListScriptJob.class);
		...
		jobDetail.addJobListener(SubPartSendListListener.class.getName());
	...
	public void init() throws Exception {
		...
		// Set up the listener
		SubPartSendListListener listener = new SubPartSendListListener();
