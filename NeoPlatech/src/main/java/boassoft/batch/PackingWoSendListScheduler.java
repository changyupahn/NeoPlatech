...
public class PackingWoSendListScheduler {
	...
	public void insertBatchSchdul() throws Exception {
		...
		jobDetail.setJobClass(PackingWoSendListScriptJob.class);
		...
		jobDetail.addJobListener(PackingWoSendListListener.class.getName());
	...
	public void init() throws Exception {
        ...
        // Set up the listener
		PackingWoSendListListener listener = new PackingWoSendListListener();
