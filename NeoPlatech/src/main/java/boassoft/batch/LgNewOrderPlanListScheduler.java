...
public class LgNewOrderPlanListScheduler {
	...
	public void insertBatchSchdul() throws Exception {
		...
		jobDetail.addJobListener(LgNewOrderPlanListListner.class.getName());
	...
	public void init() throws Exception {
        ...
        // Set up the listener
		LgNewOrderPlanListListner listener = new LgNewOrderPlanListListner();
