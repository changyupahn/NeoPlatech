...
public class PublicProductListScheduler {
	...
	public void insertBatchSchdul() throws Exception {
		...
		jobDetail.addJobListener(PublicProductListListner.class.getName());
	...
	public void init() throws Exception {
		...
		// Set up the listener
		PublicProductListListner listener = new PublicProductListListner();
