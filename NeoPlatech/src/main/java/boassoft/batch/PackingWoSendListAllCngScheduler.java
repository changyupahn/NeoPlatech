...
public class PackingWoSendListAllCngScheduler {
	...
	public void insertBatchSchdul() throws Exception {
		...
		String batchCycle = "10 0/10 * * * ?"; //매  10분마다
		...
		jobDetail.setJobClass(PackingWoSendListAllCngScriptJob.class);
		...
		jobDetail.addJobListener(PackingWoSendListAllCngListner.class.getName());
	...
	public void init() throws Exception {
		...
		// Set up the listener
		PackingWoSendListAllCngListner listener = new PackingWoSendListAllCngListner();
