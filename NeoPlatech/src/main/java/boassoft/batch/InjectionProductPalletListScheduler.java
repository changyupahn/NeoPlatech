...
public class InjectionProductPalletListScheduler {
	...
	public void insertBatchSchdul() throws Exception {
		...
		jobDetail.setJobClass(InjectionProductPalletListScriptJob.class);
		...
		jobDetail.addJobListener(InjectionProductPalletListListener.class.getName());
	...
	public void init() throws Exception {
		...
		sched = schedFact.getScheduler();		
		 // Set up the listener
		InjectionProductPalletListListener listener = new InjectionProductPalletListListener();
