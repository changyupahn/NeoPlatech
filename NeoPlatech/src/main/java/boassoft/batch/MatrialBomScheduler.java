...
public class MatrialBomScheduler {
	...
	public void insertBatchSchdul() throws Exception {
		...
		jobDetail.setJobClass(MatrialBomScriptJob.class);
		...
		jobDetail.addJobListener(MatrialBomListner.class.getName());
	...
	public void init() throws Exception {
		...
		sched = schedFact.getScheduler();		
		 // Set up the listener
		MatrialBomListner listener = new MatrialBomListner();
