...
public class AssayProductPalletListScehduler {
	...
	public void insertBatchSchdul() throws Exception {
		...
		jobDetail.setJobClass(AssayProductPalletListScriptJob.class);
		...
		jobDetail.addJobListener(AssayProductPalletListListener.class.getName());
    ...
    */
     ...
     public void init() throws Exception {
    	// 스케줄러 생성하기
 		...
 		// Set up the listener
 		AssayProductPalletListListener listener = new AssayProductPalletListListener();
