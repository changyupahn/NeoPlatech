...
public class LgGanpanListScheduler {
	...
	public void insertBatchSchdul() throws Exception {
		...
		String batchId = "batch_012";		
		String batchCycle = "0 30 3 * * ?"; //매일 새벽 3시 30분
       ...
       // Job 만들기
     	...
     	jobDetail.setJobClass(LgGanpanListScriptJob.class);
		...
		jobDetail.addJobListener(LgGanpanListListener.class.getName());
	...
	public void init() throws Exception {
    	// 스케줄러 생성하기
 		...
 		// Set up the listener
 		LgGanpanListListener listener = new LgGanpanListListener();
