...
public class PackingWoSendListODOnlyScheduler {
	...
	System.out.println("insertBatchSchdul : " + DateUtil.getFormatDate("yyyy-MM-dd hh:mm:ss"));
		...
		jobDetail.setJobClass(PackingWoSendListODOnlyScriptJob.class);
		...
		jobDetail.addJobListener(PackingWoSendListODOnlyListener.class.getName());
	...
	public void init() throws Exception {
		...
		// Set up the listener
		PackingWoSendListODOnlyListener listener = new PackingWoSendListODOnlyListener();
