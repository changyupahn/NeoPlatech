...
@Controller
public class KP8060ApprDisusePopupController {
	...
	/** log */
    protected static final Log LOG = LogFactory.getLog(KP8060ApprDisusePopupController.class);

    @RequestMapping(value="/kp8000/kp8060.do")
	public String kp8060(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
    	...
    	return "kp8000/kp8060";
	}

    @RequestMapping(value="/kp8000/kp8060Ajax.do")
	public String kp8060Ajax(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
    	CommonMap cmap = new CommonMap(request);
    ...
    /** 불용 신청 저장 */
    @RequestMapping(value="/kp8000/kp8060Proc.do")
	public String Kp8060Proc(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
    	CommonMap cmap = new CommonMap(request);
    	...
    	try {
	    	...
	    	if ("".equals(cmap.getString("rqstno"))
	    			...
	    			|| "".equals(cmap.getString("returnReseDt"))
	    	...
	    	//저장
	    	resultCnt = apprDisuseService.insertApprDisuse(cmap);
