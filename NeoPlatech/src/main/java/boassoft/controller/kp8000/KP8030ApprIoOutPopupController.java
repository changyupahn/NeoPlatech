...
public class KP8030ApprIoOutPopupController {
	...
	/** log */
    protected static final Log LOG = LogFactory.getLog(KP8030ApprIoOutPopupController.class);

    @RequestMapping(value="/kp8000/kp8030.do")
	public String kp8030(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
    	...
    	return "kp8000/kp8030";
	}

    @RequestMapping(value="/kp8000/kp8030Ajax.do")
	public String kp8030Ajax(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
    	CommonMap cmap = new CommonMap(request);
    ...
    /** 반출 신청 저장 */
    @RequestMapping(value="/kp8000/kp8030Proc.do")
	public String Kp8030Proc(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
    	CommonMap cmap = new CommonMap(request);
    	...
    	try {
	    	...
	    	if ("".equals(cmap.getString("rqstno"))
	    			...
	    			|| "".equals(cmap.getString("outDt"))
	    			|| "".equals(cmap.getString("expInDt"))
	    			|| "".equals(cmap.getString("outPlace"))
	    			|| "".equals(cmap.getString("reasonCd"))
	    	...
	    	//저장
	    	resultCnt = apprIoOutService.insertApprIoOut(cmap);
