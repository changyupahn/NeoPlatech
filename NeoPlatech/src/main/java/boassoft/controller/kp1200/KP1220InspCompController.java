...
@Controller
public class KP1220InspCompController {
	...
	/** log */
    protected static final Log LOG = LogFactory.getLog(KP1220InspCompController.class);

    @RequestMapping(value="/kp1200/kp1220.do")
	public String kp1220(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
    	...
    	return "kp1200/kp1220";
	}

    @RequestMapping(value="/kp1200/kp1220Ajax.do")
	public String kp1220Ajax(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
    	CommonMap cmap = new CommonMap(request);
    	cmap.put("dataOrder", CamelUtil.deconvert2CamelCase(cmap.getString("dataOrder")));
    	cmap.put("dataOrderArrow", cmap.getString("dataOrderArrow"));
    	cmap.put("inspCompYn", "Y");
    ...
    @RequestMapping(value="/kp1200/kp1220DtlAjax.do")
	public String kp1220DtlAjax(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
    	CommonMap cmap = new CommonMap(request);
    	cmap.put("dataOrder", CamelUtil.deconvert2CamelCase(cmap.getString("dataOrder")));
    	cmap.put("dataOrderArrow", cmap.getString("dataOrderArrow"));
    ...
    @RequestMapping(value="/kp1200/kp1220Search.do")
	public String kp1220Search(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
    	CommonMap cmap = new CommonMap(request);

    	//검색값 유지
    	model.addAttribute("cmRequest",cmap);

    	return "kp1200/kp1220Search";
	}

    @RequestMapping(value="/kp1200/kp1220Excel.do")
	public String kp1220Excel(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
    	CommonMap cmap = new CommonMap(request);
    	cmap.put("pageIdx", cmap.getString("pageIdx", "1"));
