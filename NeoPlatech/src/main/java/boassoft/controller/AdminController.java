...
public class AdminController {
    ...
    @RequestMapping(value="/validationQuery.do")
   	public String getValidationQuery(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
	...
	public String loginProc(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
    	...
    	if( adminLoginView.isEmpty()){
    		...
    		session.setAttribute("userName",adminLoginView.getString("userName"));
    ...
    @RequestMapping(value="/logoutProc.do")
   	public String logoutProc(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
    ...
    @RequestMapping(value="/system/userManageDetailAjax.do")
   	public String userManageDetailAjax(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
       	CommonMap cmap = new CommonMap(request);
       	cmap.put("orgNo", SessionUtil.getString("orgNo"));
	...
	public String userManageProc(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
    	CommonMap cmap = new CommonMap(request);
    	cmap.put("orgNo", SessionUtil.getString("orgNo"));
    	cmap.put("useYn", "Y");
	...
	public String userManageDelProc(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
    	CommonMap cmap = new CommonMap(request);
    	cmap.put("orgNo", SessionUtil.getString("orgNo"));
	...
	public String syncManage(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
    	CommonMap cmap = new CommonMap(request);
