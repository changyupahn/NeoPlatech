 ...
 * </pre>
 */
public interface EgovExcel2007Service {
     ...
     * @throws Exception
     */
    public XSSFWorkbook loadExcelTemplate(String templateName) throws Exception;
     ...
     * @throws Exception
     */
    public XSSFWorkbook loadWorkbook(String filepath) throws Exception;
     ...
     * @throws Exception
     */
    public XSSFWorkbook loadWorkbook(InputStream fileIn) throws Exception;
     ...
     * @throws Exception
     */
    public void writeWorkbook(XSSFWorkbook workbook) throws Exception;
