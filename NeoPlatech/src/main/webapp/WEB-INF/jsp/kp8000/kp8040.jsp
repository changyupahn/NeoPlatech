...
<%
String pageTitle = "반입연장신청";
String curAction = "/kp8000/kp8040.do";
String curGridAction = "/kp8000/kp8040Ajax.do";
String procAction = "/kp8000/kp8040Proc.do";
...
<body style="padding:10px 1px 1px 1px;">
	...
	<td width="50%" style="text-align: right;">
		<span class="button"><input type="button" value="반입연장신청" onclick="fnSave();"></span>
		&nbsp;
	</td>
	</tr>
	</table>
	...
	<tr>
		<th>반출일</th>
		<td>
			<%=viewData.getString("outDt")%>
		</td>
		<th>반입예정일</th>
		<td>
			<%=viewData.getString("expInDt")%>
		</td>
	</tr>
	<tr>
		<th>반출처</th>
	...
	<tr>
		<th>연장사유</th>
		<td colspan="3">
			<input type="text" id="extReason" name="extReason" value="" class="def" style="background-color:#FAF4C0;" />
		</td>
	</tr>
	<tr>
		<th>연장 반입예정일</th>
		<td colspan="3">
			<input type="text" id="extDt" name="extDt" value="" class="datepicker" style="background-color:#FAF4C0;" />
		</td>
	</tr>
	</table>
