...
<%
String pageTitle = "불용신청";
String curAction = "/kp8000/kp8060.do";
String curGridAction = "/kp8000/kp8060Ajax.do";
String procAction = "/kp8000/kp8060Proc.do";
...
function fnSave() {
	...
	var saveJsonObj = {
			...
			returnReseDt: $('#returnReseDt').val(),
			reason: $('#reason').val()
	}

	if (confirm("불용신청 하시겠습니까?")) {
		fnLoadingS2();
...
<body style="padding:10px 1px 1px 1px;">
	...
	<td width="50%" style="text-align: right;">
		<span class="button"><input type="button" value="불용신청" onclick="fnSave();"></span>
		&nbsp;
	</td>
	</tr>
	</table>
	...
	<tr>
		...
		<th>창고반납(예정)일</th>
		<td>
			<input type="text" id="returnReseDt" name="returnReseDt" value="" class="datepicker" style="background-color:#FAF4C0;" />
		</td>
	</tr>
	</table>
