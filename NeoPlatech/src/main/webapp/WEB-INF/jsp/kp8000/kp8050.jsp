...
<%
String pageTitle = "반입신청";
String curAction = "/kp8000/kp8050.do";
String curGridAction = "/kp8000/kp8050Ajax.do";
String procAction = "/kp8000/kp8050Proc.do";
String procAction2 = "/kp8000/kp8050MngProc.do";
...
<body style="padding:10px 1px 1px 1px;">
	...
	<td width="50%" style="text-align: right;">
		<%-- <span class="button"><input type="button" value="반입신청" onclick="fnSave2();"></span> --%>
		<%// if (ssAuthManager) { %>
		<span class="button"><input type="button" value="반입처리" onclick="fnSave2();"></span>
		<%// } %>
		&nbsp;
	</td>
	</tr>
	...
	<tr>
		<th>반입일</th>
		<td colspan="3">
			<input type="text" id="inDt" name="inDt" value="<%=DateUtil.getFormatDate("yyyy-MM-dd")%>" class="datepicker" style="background-color:#FAF4C0;" />
		</td>
	</tr>
	<tr>
		<th>비고</th>
		<td colspan="3">
			<input type="text" id="inRemark" name="inRemark" value="" class="def" />
		</td>
	</tr>
	<tr>
	</table>
