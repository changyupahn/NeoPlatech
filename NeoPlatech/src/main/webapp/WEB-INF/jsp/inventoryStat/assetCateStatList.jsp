...
function fnReload(){
	if (confirm("새로고침 하시겠습니까? \n확인 후 10~20초 소요됩니다.")) {
		opener.fnAssetCateStatPop();
	}
}
function fnAssetCateStatXlsDn(){
	if (confirm("엑셀다운로드 하시겠습니까? \n확인 후 10~20초 소요됩니다.")) {
		var frm = opener.document.sForm;
		frm.action = "<%=assetCateStatXlsDnAction%>";
		frm.target = "assetCateStatPop";
		frm.submit();
	}
}
</script>
...
<div style="width:900px; padding:5px;">
	...
	<h2 class="title_left">물품분류별 통계</h2>
	
	<div style="text-align:right; padding-bottom:5px;">
		<span class="button"><input type="button" value="엑셀다운로드" onclick="fnAssetCateStatXlsDn()" ></span>
	</div>

	<table class="table-list" style="width:100%">
	<tr>
		<th width="20%" class="l">물품분류</th>
		<th width="11%" class="r">조사대상(건)</th>
		<th width="11%" class="r">확인(건)</th>
		<th width="11%" class="r">미확인(건)</th>
		<th width="11%" class="r">실사율(%)</th>
	</tr>
	<%
	...
	%>
	<tr>
		<td class="l"><%=idl.getString("asset_cate")%></td>
