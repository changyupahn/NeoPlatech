...
CommonList list = RequestUtil.getCommonList(request, "hosilStatList");
float sum_total = 0;
...
function fnReload(){
	if (confirm("새로고침 하시겠습니까? \n확인 후 10~20초 소요됩니다.")) {
		opener.fnHosilStatPop();
	}
}
function fnHosilStatXlsDn(){
	if (confirm("엑셀다운로드 하시겠습니까? \n확인 후 10~20초 소요됩니다.")) {
		var frm = opener.document.sForm;
		frm.action = "<%=hosilStatXlsDnAction%>";
		frm.target = "hosilStatPop";
		frm.submit();
	}
}
</script>
...
<div style="width:900px; padding:5px;">
	...
	<h2 class="title_left">호실별 통계</h2>
	
	<div style="text-align:right; padding-bottom:5px;">
		<span class="button"><input type="button" value="엑셀다운로드" onclick="fnHosilStatXlsDn()" ></span>
	</div>

	<table class="table-list" style="width:100%">
	<tr>
		<th width="16%" class="l">호실</th>
	...
	%>
	<tr>
		<td class="l"><%=idl.getString("hosil")%></td>
