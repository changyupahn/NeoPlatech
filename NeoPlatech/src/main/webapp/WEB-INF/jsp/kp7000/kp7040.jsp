...
<%
String pageTitle = "반입연장신청정보";
String curAction = "/kp7000/kp7040.do";
String curGridAction = "/kp7000/kp7040Ajax.do";
...
<body style="padding:10px 1px 1px 1px;">
	...
	<table id="listInfo01" class="scroll" style="padding-top:0px;"></table>
