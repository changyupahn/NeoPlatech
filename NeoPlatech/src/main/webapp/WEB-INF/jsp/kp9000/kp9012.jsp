...
String curAction = "/kp9000/kp9012.do";
...
<script type="text/javascript" src="/common/js/kp9012.js"></script>
...
<body>
	...
	<div id="treeData">
		...
		%>
		<input type="hidden" name="kp9012TreeData" value="<%=seq%>|<%=codeName%>|<%=pseq%>|<%=code%>|<%=useYn%>|<%=usefulLife%>|<%=depreCd%>|<%=assetTypeCd%>|0" />
		<%
		}
		%>
	</div>
