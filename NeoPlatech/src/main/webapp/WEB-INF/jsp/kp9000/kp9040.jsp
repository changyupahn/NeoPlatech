...
<%
String pageTitle = "위치코드";
String curAction = "/kp9000/kp9040.do";
...
<script type="text/javascript" src="/common/js/kp9040.js"></script>
...
<body>
	...
	<div id="treeData">
		<input type="hidden" name="kp9040TreeData" value="0|위치코드||0|Y" />
		<%
		...
		%>
		<input type="hidden" name="kp9040TreeData" value="<%=code%>|<%=codeName%>|<%=pseq%>|0|Y" />
		<%
		}
		%>
	</div>
