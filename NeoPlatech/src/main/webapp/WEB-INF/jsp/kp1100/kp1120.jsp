...
<%
String pageTitle = "부서코드관리";
String curAction = "/kp1100/kp1120.do";
String curExcel = "/kp1100/kp1120Excel.do";
String curProc = "/kp1100/kp1120Proc.do";
String curDelProc = "/kp1100/kp1120DelProc.do";
...
<script type="text/javascript" src="/common/js/kp1120.js"></script>
...
<body>
	...
	<div id="treeData">
		<input type="hidden" name="kp1120TreeData" value="0000000000|부서코드||0|Y" />
		<%
		...
		%>
		<input type="hidden" name="kp1120TreeData" value="<%=code%>|<%=codeName%>|<%=pseq%>|0|Y" />
		<%
		}
		%>
	</div>
