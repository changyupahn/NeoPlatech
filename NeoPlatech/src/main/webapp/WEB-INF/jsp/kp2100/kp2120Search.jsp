...
<%
String curAction = "/kp2100/kp2120Search.do";
...
<table class="search01">
	...
	<% idx++; if (idx % colcnt == 0) { colmax = idx; idx = 0;%></tr><tr><% } %>
		<th>날짜 :</th>					
		<td>
			<input type="text" id="searchDtKeyword" name="searchDtKeyword" value="<%=cmRequest.getString("searchDtKeyword")%>" class="datepicker dt1" />		
		</td>			    
