...
<%
String pageTitle = "부자재출고관리";
String curAction = "/kp2100/kp2151.do";
String curGridAction = "/kp2100/kp2151DetailAjax.do";
String curSearchAction = "/kp2100/kp2151Search.do";
String xlsDnAction = "/kp2100/kp2151Excel.do";
String detailAction = "/kp2100/kp2151.do";
...
function fnInitSearchForm() {
	...
	$.ajax({
		...
		data : {			
			colcnt : colcnt,
			goWith : '<%=cmRequest.getString("goWith")%>'
		},
...
<%@ include file="/WEB-INF/jsp/common/top.jsp" %>
    ...
    <input type="hidden" id="goWith" name="goWith" value="<%=cmRequest.getString("goWith", "")%>" />
