...
String curAction = "/kp2100/kp2120.do";
String curGridAction = "/kp2100/kp2120Ajax.do";
String curSearchAction = "/kp2100/kp2120Search.do";
String xlsDnAction = "/kp2100/kp2120Excel.do";
...
var colNames01 = [
                  'rowNum','odId','demandId','부품번호','품목명','주문일자','품번','주문수량','소요수량','총소요량','최종수량'
                  ];
                  
                  
var colModel01 = [      
                  {name:'rowNum', index:'rowNum', width:'0px', hidden:true},
                  {name:'odId', index:'odId', width:'0px', hidden:true},
                  {name:'demandId', index:'demandId', width:'0px', hidden:true},
                  {name:'mPartNo', index:'mPartNo', width:'250px', align:'LEFT', columntype:'text', sortable:false, classes:'grid-col-TEXT'},
				    {name:'tool', index:'tool', width:'250px', align:'LEFT', columntype:'text', sortable:false, classes:'grid-col-TEXT'},  				    
				    {name:'neoDate', index:'neoDate', width:'250px', align:'LEFT', columntype:'text', sortable:false, classes:'grid-col-TEXT'},  				    
				    {name:'subPartNo', index:'subPartNo', width:'250px', align:'LEFT', columntype:'text', sortable:false, classes:'grid-col-TEXT'},
				    {name:'planQty', index:'planQty', width:'250px', align:'LEFT', columntype:'text', sortable:false, classes:'grid-col-TEXT'},
				    {name:'bomQty', index:'bomQty', width:'250px', align:'LEFT', columntype:'text', sortable:false, classes:'grid-col-TEXT'},
				    {name:'sumQty', index:'sumQty', width:'250px', align:'LEFT', columntype:'text', sortable:false, classes:'grid-col-TEXT'},
				    {name:'sumQtyCng', index:'sumQtyCng', width:'250px', align:'LEFT', columntype:'text', sortable:false, classes:'grid-col-TEXT'}  				 
				  ];
