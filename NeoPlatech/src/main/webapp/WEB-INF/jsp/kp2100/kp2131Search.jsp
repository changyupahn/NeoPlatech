...
<%
String curAction = "/kp2100/kp2131Search.do";
String curComboItemAction =  "/kp2100/kp2131ComboItemAjax.do";
String curComboPNoAction =  "/kp2100/kp2131ComboPNoAjax.do";
...
<table class="search01">
	...
	<% idx++; if (idx % colcnt == 0) { colmax = idx; idx = 0;%></tr><tr><% } %>
		...
		<td>
			...
			<option value="">전체</option>
			<c:import url="/code/comboPNoList.do" charEncoding="utf-8">
			<c:param name="paramCodeId" value="" />
			<c:param name="paramSltValue" value="" />
			</c:import>
			</select>
