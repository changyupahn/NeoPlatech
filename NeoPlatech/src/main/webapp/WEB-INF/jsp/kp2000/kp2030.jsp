...
<%
String pageTitle = "게이트통과내역";
String curAction = "/kp2000/kp2030.do";
String curGridAction = "/kp2000/kp2030Ajax.do";
String curSearchAction = "/kp2000/kp2030Search.do";
String xlsDnAction = "/kp2000/kp2030Excel.do";
...
var colNames01 = ["assetSeq","gateNo","게이트위치","통과일시"
<%
...
var colModel01 = [
				...
				,{name:'gateNo', index:'gateNo', width:'0px', hidden:true}
				,{name:'gateName', index:'gateName', width:'100px', align:'CENTER', columntype:'text', classes:'grid-col-TEXT'}
				,{name:'gateDt', index:'gateDt', width:'100px', align:'CENTER', columntype:'text', classes:'grid-col-DATE', formatter: fnFormatterDate}
<%
if (dispMngList != null) {
	for (int k=0; k<dispMngList.size(); k++) {
		CommonMap dispMng = dispMngList.getMap(k);
