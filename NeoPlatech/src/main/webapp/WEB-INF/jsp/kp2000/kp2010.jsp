...
<%
String pageTitle = "자산변경내역";
String curAction = "/kp2000/kp2010.do";
String curGridAction = "/kp2000/kp2010Ajax.do";
String curSearchAction = "/kp2000/kp2010Search.do";
String xlsDnAction = "/kp2000/kp2010Excel.do";
...
var colNames01 = [
                  'histSeq','assetSeq','histTypeCd','자산번호','품명','규격','이력구분','변경일시','내용','변경자'
                  ];
var colModel01 = [
					...
					{name:'assetName', index:'assetName', width:'150px', align:'LEFT', columntype:'text', sortable:false, classes:'grid-col-TEXT'},
					{name:'assetSize', index:'assetSize', width:'150px', align:'LEFT', columntype:'text', sortable:false, classes:'grid-col-TEXT'},
