...
String curAction = "/kp1300/kp1313AsWrite.do";
...
String listAction = "/kp1300/kp1313As.do";
	...
	if (confirm("저장 하시겠습니까?")) {
		...
		$.ajax({
			...
			success:function(data)
			{
				if (data.ret == "OK") {
					alert("저장 되었습니다.");
					location.href = "<%=listAction%>?assetSeq=<%=cmRequest.getString("assetSeq")%>";
				} else {
					alert(data.retmsg);
				}
			},
...
<body style="overflow:auto;padding:1px;">
	...
	<table style="width:100%">
		<tr>
		<td width="50%">
			<% if ("".equals(viewData.getString("operSeq"))) { %>
	...
	<input type="hidden" id="operSeq" name="operSeq" value="<%=viewData.getString("operSeq")%>" />
