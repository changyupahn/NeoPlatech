...
<%
String pageTitle = "유지보수일지 목록";
String curAction = "/kp1300/kp1313As.do";
String curTabAction = "/kp1300/kp1313AsTab.do";
String assetTabAction = "/kp1300/kp1311Tab.do";
String curGridAction = "/kp1300/kp1313AsAjax.do";
String procAction = "/kp1300/kp1313AsProc.do";
String modifyAction = "/kp1300/kp1313AsWrite.do";
String delProcAction = "/kp1300/kp1313AsDelProc.do";
...
var colModel01 = [
  				{name:'operSeq', index:'operSeq', width:'0px', hidden:true},
...
<body style="overflow:auto;padding:1px;">
	...
	<td style="vertical-align:top;padding-top:0px;">
		...
		<div style="border:1px solid gray;background-color:#FFE08C;padding:10px;margin-top:0px">
			<span style="color:black;font-weight:bold;">■ 유지보수일지 목록</span>
		</div>
