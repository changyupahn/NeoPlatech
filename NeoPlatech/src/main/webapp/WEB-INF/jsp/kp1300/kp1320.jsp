...
<%
String pageTitle = "자산검수";
String detailAction = "/kp1300/kp1311.do";
String curAction = "/kp1300/kp1320.do";
String curGridAction = "/kp1300/kp1320Ajax.do";
String curSearchAction = "/kp1300/kp1310Search.do";
String xlsDnAction = "/kp1300/kp1320Excel.do";
String writeAction = "/kp1300/kp1311.do";
String writeXlsUpAction = "/kp1300/kp1319.do";
String procAction = "/kp1300/kp1320Proc.do";
...
function fnWrite() {
	$('#layerPop').click();
	$('#iframe').attr("src", "<%=writeAction%>?menuDiv=2");
	$('#layer_iframe').show();
}
function fnWriteXlsUp() {
	$('#layerPop').click();
	$('#iframe').attr("src", "<%=writeXlsUpAction%>?menuDiv=2");
	$('#layer_iframe').show();
}
...
<body>
	...
	<td width="50%" style="text-align: right;">
		...
		<span class="button"><input type="button" value="검수처리" onclick="fnSave();"></span>
		<!-- <span class="button"><input type="button" value="수기등록" onclick="fnWrite();"></span>
		<span class="button"><input type="button" value="수기등록(엑셀업로드)" onclick="fnWriteXlsUp();"></span> -->
		<% } %>
		&nbsp;
	</td>
	</tr>
