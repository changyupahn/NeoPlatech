...
<%
String pageTitle = "삭제자산관리";
String detailAction = "/kp1300/kp1311.do";
String curAction = "/kp1300/kp1350.do";
String curGridAction = "/kp1300/kp1350Ajax.do";
String curSearchAction = "/kp1300/kp1310Search.do";
String xlsDnAction = "/kp1300/kp1350Excel.do";
String procAction = "/kp1300/kp1350Proc.do";
...
<body>
	...
	<td width="50%" style="text-align: right;">
		...
		<span class="button"><input type="button" value="삭제복구" onclick="fnSave();"></span>
		&nbsp;
	</td>
	</tr>
	</table>
