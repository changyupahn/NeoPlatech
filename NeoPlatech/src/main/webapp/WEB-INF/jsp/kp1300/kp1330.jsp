...
<%
String pageTitle = "부외전환";
String detailAction = "/kp1300/kp1311.do";
String curAction = "/kp1300/kp1330.do";
String curGridAction = "/kp1300/kp1330Ajax.do";
String curSearchAction = "/kp1300/kp1310Search.do";
String xlsDnAction = "/kp1300/kp1330Excel.do";
String procAction = "/kp1300/kp1330Proc.do";
...
<body>
	...
	<td width="50%" style="text-align: right;">
		...
		<span class="button"><input type="button" value="부외전환" onclick="fnSave();"></span>
		&nbsp;
	</td>
	</tr>
	</table>
