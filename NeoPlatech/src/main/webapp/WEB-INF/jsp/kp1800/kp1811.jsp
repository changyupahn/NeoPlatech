...
<%
String pageTitle = "ZEUS국가연구시설장비 - 월별작성현황";
String curAction = "/kp1800/kp1811.do";
String curTabAction = "/kp1800/kp1810Tab.do";
String curGridAction = "/kp1800/kp1811Ajax.do";
String curSearchAction = "/kp1800/kp1810Search.do";
String xlsDnAction = "/kp1800/kp1811Excel.do";
...
var colModel01 = [
				...
				{name:'rnum', index:'rnum', width:'80px', align:'CENTER', columntype:'text', sortable:false, classes:'grid-col-TEXT'},
  				...
  				{name:'gubnStr', index:'gubnStr', width:'100px', align:'CENTER', columntype:'text', sortable:false, classes:'grid-col-TEXT'},
  				{name:'cnt01', index:'cnt01', width:'70px', align:'CENTER', columntype:'text', sortable:false, classes:'grid-col-TEXT', formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0}},
  				{name:'cnt02', index:'cnt02', width:'70px', align:'CENTER', columntype:'text', sortable:false, classes:'grid-col-TEXT', formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0}},
  				{name:'cnt03', index:'cnt03', width:'70px', align:'CENTER', columntype:'text', sortable:false, classes:'grid-col-TEXT', formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0}},
  				{name:'cnt04', index:'cnt04', width:'70px', align:'CENTER', columntype:'text', sortable:false, classes:'grid-col-TEXT', formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0}},
  				{name:'cnt05', index:'cnt05', width:'70px', align:'CENTER', columntype:'text', sortable:false, classes:'grid-col-TEXT', formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0}},
  				{name:'cnt06', index:'cnt06', width:'70px', align:'CENTER', columntype:'text', sortable:false, classes:'grid-col-TEXT', formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0}},
  				{name:'cnt07', index:'cnt07', width:'70px', align:'CENTER', columntype:'text', sortable:false, classes:'grid-col-TEXT', formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0}},
  				{name:'cnt08', index:'cnt08', width:'70px', align:'CENTER', columntype:'text', sortable:false, classes:'grid-col-TEXT', formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0}},
  				{name:'cnt09', index:'cnt09', width:'70px', align:'CENTER', columntype:'text', sortable:false, classes:'grid-col-TEXT', formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0}},
  				{name:'cnt10', index:'cnt11', width:'70px', align:'CENTER', columntype:'text', sortable:false, classes:'grid-col-TEXT', formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0}},
  				{name:'cnt11', index:'cnt12', width:'70px', align:'CENTER', columntype:'text', sortable:false, classes:'grid-col-TEXT', formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0}},
  				{name:'cnt12', index:'cnt13', width:'70px', align:'CENTER', columntype:'text', sortable:false, classes:'grid-col-TEXT', formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0}},
  				{name:'sum01', index:'sum01', width:'70px', align:'CENTER', columntype:'text', sortable:false, classes:'grid-col-TEXT', formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0}}
  				];
var groupHeaders01 = [[
       				{startColumnName:'cnt01',numberOfColumns:13,skipInit:0,titleText:'<%=firstStatYear%>년도 월별 작성현황(일)'}
                    ]];
...
// 			}
		...
		loadComplete : function(data) {
			...
			//totalRow
			$('#spanTotalRow').html(data.totalRow / 2);

		},
		gridComplete : function() {
			//jsGridHideCell('listInfo01', 'equipNo');
			//jsGridHideCell('listInfo01', 'korNm');
			//jsGridHideCell('listInfo01', 'assetNo');

			jsGridRowspanCell('listInfo01', 'rnum');
			jsGridRowspanCell('listInfo01', 'equipNo');
			jsGridRowspanCell('listInfo01', 'korNm');
			jsGridRowspanCell('listInfo01', 'assetNo');
