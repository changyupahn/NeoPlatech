...
function fnSave(){
	alert(  document.getElementById('sample4_postcode').value);
	alert(  document.getElementById('sample4_roadAddress').value);
	alert(  document.getElementById('sample4_jibunAddress').value);
	alert(  document.getElementById('sample4_detailAddress').value);
	alert(  document.getElementById('sample4_extraAddress').value);
	...
	opener.parent.fnSetKp1970(postcode,roadAddress,jibunAddress,detailAddress,extraAddress);
}    
</script>
<div class="buttonDiv">
