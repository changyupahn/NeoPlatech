...
function fnInitTreeData(){
	...
	//그룹 트리 구조 생성
	$('#treeData input[name="kp9050TreeData"]').each(function(){
		...
		if( spt.length > 4 ){
			...
			if( $('#KP_TREE_'+spt[0]).length == 0 ){
				...
				//this
				$('#KP_UL_'+ spt[2]).append('<li id="KP_TREE_'+ spt[0] +'" customcode="'+ spt[3] +'" rel="'+ (spt[4]=="Y"?"folder":"delete") +'"><a href="#" title="'+ spt[1] +'">'+ spt[1]+'</a></li>');
			}
		}
	});
}
